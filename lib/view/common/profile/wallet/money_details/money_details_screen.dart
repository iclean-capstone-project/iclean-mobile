...
import 'components/details_money.dart';
import 'components/funds_money.dart';
import 'components/information_money.dart';

class MoneyDetailsScreen extends StatelessWidget {
  const MoneyDetailsScreen({super.key, required this.transaction});
                ...
                return Column(
                  children: [
                    Padding(
                      ...
                      child: DetailsMoney(transaction: transactionDetails),
                    ),
                    const SizedBox(height: 16),
                    FundsMoney(transaction: transactionDetails),
                    const SizedBox(height: 16),
                    InformationMoney(transaction: transactionDetails),
                  ],
                );
              }
